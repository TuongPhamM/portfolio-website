const projectsData = [
  ...
  },
  {
    ...
    url: "https://github.com/brinkbrink/FWCCN",
  },
  {
    ...
    content:
      "OED is The Open Energy Dashboard (OED) is a free, open source project that provides a web-based application to display energy information in a web browser and allows for the observation collection, graphing and conversions of various metrics and units of energy consumption. LG19 test is one of the many tests out there of OED purpose to ensure data unit and metric conversion is accurate, since some of them were created, our LG19 test would be similar and we just need to focus on the pattern and what makes LG19 test different.",
    url: "https://www.linkedin.com/feed/update/urn:li:activity:7168880000018866176/",
  },
